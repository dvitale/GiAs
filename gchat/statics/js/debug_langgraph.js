...
class LangGraphDebugChatBot {
    ...
    updateIntentDisplay(response) {
        if (response.intent) {
            ...
            const intentDescriptions = {
                ...
                'ask_nearby_priority': 'Stabilimenti prioritari per prossimità geografica',
    ...
    updateAgentsDisplay(response) {
        ...
        const pathToAgent = {
            ...
            'info_procedure_tool': { name: 'Info Procedure', category: 'procedure' },
            'nearby_priority_tool': { name: 'Nearby Priority', category: 'proximity' },
        ...
        const intentToAgent = {
            ...
            'ask_nearby_priority': { name: 'nearby_priority_tool', category: 'proximity' },
